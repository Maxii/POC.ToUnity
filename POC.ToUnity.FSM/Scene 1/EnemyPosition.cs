...
public class EnemyPosition : MonoBehaviour {
    ...
    void Update() {
        ...
        if (_path != null && _path.vectorPath != null && _currentPosition < _path.vectorPath.Count) {   // was .Length???

            while (distanceToTravel > 0 && _currentPosition < _path.vectorPath.Count) { // was .Length???
